...
1.	The use of PHP tags/code in Smarty template files has been completely removed as of
...
2.	The core Loader file is extended with a `MY_Loader.php` file, and the `view()`
...
I'll provide limited support for installation/use if needed. If you find a bug or issue
with the code, create an Issue or contact me.
